...
with DAG(
        dag_id='taxonomy_code_etl_data_processing',
        description=__doc__,
        ...
        params={
            'local_folder_name': Variable.get(key='local_folder_name', default_var='taxonomy_code'),
            'root_url': Variable.get(
                key='root_url',
                default_var='https://www.nucc.org/index.php/code-sets-mainmenu-41/provider-taxonomy-mainmenu-40/csv-mainmenu-57'
            ),
        },
) as dag:
    # region doc
