"""Refresh descriptions and payment rates for all OPPS APCs (OPPS Addendum A)"""
...
from common.opps_addendum_common.extract import download_files, get_all_download_urls
...
with DAG(
        dag_id='opps_addendum_a_etl_data_processing',
        description=__doc__,
        ...
        params={
            'local_folder_name': Variable.get(key='local_folder_name', default_var='opps_addendum_a'),
            'root_url': Variable.get(
                key='root_url',
                default_var='https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment/HospitalOutpatientPPS/Addendum-A-and-Addendum-B-Updates'
            ),
            'addendum_type': 'a',
        },
) as dag:
    ...
    ] >> main__get_all_download_urls__task >> main__download_files__task >> main__get_all_data__task >> \
    main__load_data_to_db__task >> teardown__cleanup__task >> [
